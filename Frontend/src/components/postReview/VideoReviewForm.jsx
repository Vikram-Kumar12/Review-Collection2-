...
export default function VideoReviewForm() {
  ...
  const handleSubmit = () => {
    if (!video || description.trim().length < minChars) {
      ...
      <div className=" rounded-2xl p-1 border border-gray-600 shadow-sm">
        <div className="p-4">
          {!video ? (
            ...
            >
              <div className="max-w-md mx-auto">
                ...
                <p className="text-lg font-medium text-gray-300">Upload your video review</p>
                <p className="text-sm text-gray-400 mt-1">Drag and drop your video here or click to browse</p>
                <p className="text-xs text-gray-400 mt-2">Supported formats: MP4, MOV, AVI, etc.</p>
                <input
                  type="file"
                  ref={fileInputRef}
                  accept="video/*"
          ...
          <div className="mt-6">
            ...
            />
            <div className={`text-right text-sm mt-1 ${description.length < minChars ? 'text-red-500' : 'text-green-600'}`}>
        ...
        <div className="flex items-center justify-between border-t border-gray-400 p-4">
          ...
          <button 
            ...
            disabled={isSubmitting || !video || description.length < minChars}
