  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="relative">
        ...
        />
        <div className={`absolute bottom-3 right-3 text-sm ${charCount < minChars ? 'text-red-500' : 'text-green-600'} transition-colors duration-300 bg-white px-2 py-1 rounded-full`}>
          {charCount}/{minChars}
        </div>
      </div>
